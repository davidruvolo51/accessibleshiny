...
module.exports = {
  "datatable": "datatable",
  "hidden-colname": "hidden-colname",
  "row-highlighting": "row-highlighting",
  "caption-side-top": "caption-side-top",
  "caption-side-bottom": "caption-side-bottom",
  "progress-bar-parent": "progress-bar-parent",
  "progress-bar-container": "progress-bar-container",
  "progress-bar-fixed": "progress-bar-fixed",
  ...
  "accordion-button-label": "accordion-button-label",
  "accordion-button-icon": "accordion-button-icon",
  "rotated": "rotated",
...
$.extend(Accordion, {
  ...
  subscribe: function subscribe(el, callback) {
    ...
    var section = $(el).find(".accordion-section"); // onClick event
...
var _setDocMeta2 = _interopRequireDefault(require("./js/_setDocMeta"));
...
window.addEventListener("DOMContentLoaded", function (e) {
  (0, _setDocMeta2.default)();
}, {
  once: true
}); // register bindings

Shiny.inputBindings.register(_accordion.default);
},{"./scss/index.scss":"scss/index.scss","./js/_setDocMeta":"js/_setDocMeta.js","./js/_accordion":"js/_accordion.js"}],"../../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
